...
pub struct Settings {
    ...
    /// Legacy HTTP/3 datagram setting used by Cloudflare Access MASQUE.
    pub(crate) enable_datagram_00: bool,
...
impl From<&frame::Settings> for Settings {
    fn from(settings: &frame::Settings) -> Self {
        ...
        Self {
            ...
            enable_datagram_00: settings
                .get(frame::SettingId::H3_DATAGRAM_00)
                .map(|value| value != 0)
                .unwrap_or(defaults.enable_datagram_00),
...
impl TryFrom<Config> for frame::Settings {
    ...
    fn try_from(value: Config) -> Result<Self, Self::Error> {
        ...
        if enable_datagram_00 {
            settings.insert(frame::SettingId::H3_DATAGRAM_00, 1)?;
        }
        settings.insert(
