...
impl Builder {
    ...
    /// Sends the legacy draft HTTP/3 datagram setting used by Cloudflare Access.
    pub fn enable_datagram_00(&mut self, enabled: bool) -> &mut Self {
        self.config.settings.enable_datagram_00 = enabled;
        self
    }
