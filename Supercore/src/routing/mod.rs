...
fn geosite_domains(country: &str) -> &'static [&'static str] {
    match country {
        "cn" | "china" => &[
            "baidu.com", "baidu.cn", "bdstatic.com", "bdimg.com",
            "bilibili.com", "hdslb.com", "biliapi.net",
            "qq.com", "qzone.com", "gtimg.cn", "idqqimg.com", "myapp.com",
            "taobao.com", "tmall.com", "alicdn.com", "alibaba.com", "aliyun.com",
            "alipay.com", "aliexpress.com",
            "jd.com", "360buyimg.com", "jd.hk",
            "163.com", "126.com", "netease.com", "nosdn.127.net",
            "sina.com", "weibo.com", "sinaimg.cn", "weibo.cn",
            "zhihu.com", "zhimg.com",
            "douyin.com", "douyinpic.com", "snssdk.com",
            ...
            "vivo.com",
            "tencent.com", "gtimg.com", "qpic.cn",
            "gov.cn", "edu.cn", "ac.cn", "com.cn", "net.cn", "org.cn",
            "cn",
        ...
        "google" => &[
            ...
            "googlevideo.com", "google.com.tw", "google.com.sg",
            "google.co.jp", "google.co.uk", "google.de", "google.fr",
            "android.com", "chromium.org", "chrome.com",
            "gmail.com", "googlemail.com",
            "googlemaps.com", "maps.google.com",
        ...
        "github" => &[
            ...
            "githubapp.com", "githubassets.com",
        ],
        "microsoft" => &[
            "microsoft.com", "windows.com", "windowsupdate.com",
        ...
        "apple" => &[
            "apple.com", "icloud.com", "mzstatic.com",
            "apple.news", "appstore.com",
            "me.com", "mac.com",
        ],
        "amazon" => &[
            "amazon.com", "amazonaws.com", "amazon.cn",
...
pub fn target_matches(target: RuleTarget, value: &str, destination: &Destination) -> bool {
    ...
    match target {
        ...
        RuleTarget::IpCidr | RuleTarget::IpCidr6 => {
        ...
        RuleTarget::GeoSite => {
            let country = value.to_ascii_lowercase();
            let domains = geosite_domains(&country);
        ...
        RuleTarget::AppPathRegex => {
            destination
                ...
                .map(|path| {
                    regex::Regex::new(&value)
                        .map(|re| re.is_match(&path.to_ascii_lowercase()))
                        .unwrap_or(false)
                })
                .unwrap_or(false)
        }
