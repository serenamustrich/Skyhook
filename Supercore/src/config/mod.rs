...
impl Default for TunConfig {
    fn default() -> Self {
        Self {
            ...
            route_exclude_address: default_tun_route_exclude(),
            include_uid: Vec::new(),
...
fn default_tun_bypass() -> Vec<String> {
    vec![
...
fn default_tun_route_exclude() -> Vec<String> {
    vec!["17.0.0.0/8".to_string()]
}
...
fn default_subscription_store_path() -> PathBuf {
    PathBuf::from("supercore-subscriptions")
}
...
fn default_smart_state_path() -> PathBuf {
    PathBuf::from("supercore-smart-rules.json")
}
