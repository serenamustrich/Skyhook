...
- full：Shadowsocks、ShadowsocksR、Snell、Trojan、VMess、VLESS、Hysteria2、TUIC、WireGuard、AnyTLS、ShadowTLS、Naive、HTTP、SOCKS5、SSH。其他协议按具体路径提供能力，但尚未满足整个协议标记为 full 的证据标准。
