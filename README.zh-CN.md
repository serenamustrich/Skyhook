...
- full：Shadowsocks、ShadowsocksR、Snell、Trojan、VMess、VLESS、Hysteria2、TUIC、WireGuard、AnyTLS、ShadowTLS、SOCKS5。其他协议按具体路径提供能力，但尚未满足整个协议标记为 full 的证据标准。
- partial：Naive、HTTP、SSH。
